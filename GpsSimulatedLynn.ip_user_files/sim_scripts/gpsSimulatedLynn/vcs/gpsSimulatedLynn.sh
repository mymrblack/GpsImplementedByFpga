...
#
# Generated by Vivado on Wed Nov 23 17:46:37 +0800 2016
# IP Build 1577682 on Fri Jun  3 12:00:54 MDT 2016 
#
# usage: gpsSimulatedLynn.sh [-help]
# usage: gpsSimulatedLynn.sh [-lib_map_path]
# usage: gpsSimulatedLynn.sh [-noclean_files]
# usage: gpsSimulatedLynn.sh [-reset_run]
#
...
# executing this script. Please type 'gpsSimulatedLynn.sh -help' for more information.
#
...
# Script info
echo -e "gpsSimulatedLynn.sh - Script generated by export_simulation (Vivado v2016.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/gpsSimulatedLynn/ip/gpsSimulatedLynn_processing_system7_0_0/sim/gpsSimulatedLynn_processing_system7_0_0.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/gpsSimulatedLynn/ip/gpsSimulatedLynn_axi_uartlite_0_0/sim/gpsSimulatedLynn_axi_uartlite_0_0.vhd" \
  2>&1 | tee -a vhdlan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/gpsSimulatedLynn/ipshared/xilinx.com/gpsipsimulatedlynn_v1_0/hdl/gpsIpSimulatedLynn_v1_0_GPS_AXI.v" \
    "$ref_dir/../../../bd/gpsSimulatedLynn/ipshared/xilinx.com/gpsipsimulatedlynn_v1_0/hdl/gpsIpSimulatedLynn_v1_0.v" \
    "$ref_dir/../../../bd/gpsSimulatedLynn/ip/gpsSimulatedLynn_gpsIpSimulatedLynn_0_0/sim/gpsSimulatedLynn_gpsIpSimulatedLynn_0_0.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/gpsSimulatedLynn/ip/gpsSimulatedLynn_rst_processing_system7_0_100M_0/sim/gpsSimulatedLynn_rst_processing_system7_0_100M_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/gpsSimulatedLynn/ip/gpsSimulatedLynn_xbar_0/sim/gpsSimulatedLynn_xbar_0.v" \
    "$ref_dir/../../../bd/gpsSimulatedLynn/hdl/gpsSimulatedLynn.v" \
  2>&1 | tee -a vlogan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/gpsSimulatedLynn/ip/gpsSimulatedLynn_auto_pc_0/sim/gpsSimulatedLynn_auto_pc_0.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.gpsSimulatedLynn xil_defaultlib.glbl -o gpsSimulatedLynn_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./gpsSimulatedLynn_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./gpsSimulatedLynn.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key gpsSimulatedLynn_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc gpsSimulatedLynn_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./gpsSimulatedLynn.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: gpsSimulatedLynn.sh [-help]\n\
Usage: gpsSimulatedLynn.sh [-lib_map_path]\n\
Usage: gpsSimulatedLynn.sh [-reset_run]\n\
Usage: gpsSimulatedLynn.sh [-noclean_files]\n\n\
